  ...
  return (
    <div className="wrapper w-[85px] h-[85px] flex items-center justify-center">
      <div className="text-5xl w-[60px] h-[60px] rounded-full text-[#41BE90] bg-[#D8F9ED]">
        <div className="w-[60px] h-[60px] relative left-[-10px] flex rtl:flex-row-reverse items-center rotate-[-25deg]">
          <span className="h-full flex flex-col gap-1 rtl:items-start items-end justify-center">
