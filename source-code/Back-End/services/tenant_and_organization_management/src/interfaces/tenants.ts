...
import { auditingFields, subscriptionFieldsOptional, subscriptionFieldsUnion } from "../types/tenants";
...
/**
 * Interface representing the response structure for retrieving a tenant with subdivisions heirarchy and childrens
 *
 * This interface extends `Tenant` and is typically used in the API responses to return tenant data.
 */
export interface tenantExtendedResponseDTO extends tenantResponseDTO {
